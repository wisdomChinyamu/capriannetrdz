...
- [x] Create Firestore collections:
  ...
  - `accounts` (indexed by userId)
  - `transactions` (indexed by userId)
...
- [x] Enable Storage with proper rules:
...
- [x] Create Authentication method (Email/Password)

- [x] Set up Firebase emulator for local development (optional)
