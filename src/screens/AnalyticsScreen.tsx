  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.metricsGrid}>
          <View style={styles.metricCard}>
            ...
            <Text style={styles.metricValue}>{metrics.winRate.toFixed(1)}%</Text>
          </View>
          <View style={styles.metricCard}>
          ...
          <View style={styles.metricCard}>
            ...
            <Text style={styles.metricValue}>{metrics.profitFactor.toFixed(2)}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        {Object.entries(metrics.performanceByPair).map(([pair, winRate]) => (
          <View key={pair} style={styles.performanceRow}>
            <Text style={styles.performanceLabel}>{pair}</Text>
      ...
      <View style={styles.section}>
        ...
        {Object.entries(metrics.performanceBySession).map(([session, winRate]) => (
