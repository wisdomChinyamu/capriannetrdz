...
export default function ImageUploader({
  ...
  const handleWebPicker = useCallback(() => {
    ...
    input.onchange = async (e: any) => {
      ...
      setUploading(true);
      try {
        // Generate a temporary ID for the trade (in a real app, this would come from context or be generated by backend)
        const tempTradeId = `trade_${Date.now()}`;
        const supabaseUrl = await uploadTradeImage(tempTradeId, file);
